...
Citizen.CreateThread(function()
	while true do
		...
		if not processo then
			...
			for k,v in pairs(arvores) do
				...
				if distance <= 25 and not list[k] then
					...
					if distance <= 1.2 then
						drawTxt("PRESSIONE  ~r~E~w~  PARA COLHER ~o~LARANJAS~w~",4,0.5,0.90,0.50,255,255,255,200)
			...
			drawTxt("AGUARDE ~g~"..segundos.."~w~ SEGUNDOS ATÉ TERMINAR DE COLHER AS ~o~LARANJAS",4,0.5,0.90,0.50,255,255,255,200)
		end
	end
end)
