...
local CoordenadaX = 306.58
local CoordenadaY = -597.51
...
local payment = 1 --10
-----------------------------------------------------------------------------------------------------------------------------------------
-- 306.58,-597.51,43.28  -- Nova
-- 338.85,-587.38,43.32   -- Antiga
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
		...
		if not emservico then
			...
			if distance <= 3 then
				...
				if distance <= 1.2 then
					drawTxt("PRESSIONE  ~r~E~w~  PARA ~y~INICIAR O SERVIÇO",4,0.5,0.90,0.50,255,255,255,200)
...
Citizen.CreateThread(function()
	while true do
		...
		if emservico then
			...
			if distance <= 50.0 and IsVehicleModel(vehicle,GetHashKey("sprintersamu")) then
