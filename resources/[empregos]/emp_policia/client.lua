...
local coordenadas = {
	{ ['id'] = 1, ['x'] = 440.17, ['y'] = -975.67, ['z'] = 30.68 }, 
	--{ ['id'] = 1, ['x'] = 452.37,-980.11,30.68 },  Colocar o Arsenal
	--{ ['id'] = 2, ['x'] = -449.96,6010.79,31.72 }, 
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- RESIDENCIAS
-----------------------------------------------------------------------------------------------------------------------------------------
			...
			if distance <= 30.0 then
				...
				if distance <= 4.5 then
					if emP.checkPermission() then
						if IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("pmerj")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("bpchq")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("bmw1200gs")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("versapmerj")) or IsVehicleModel(GetVehiclePedIsUsing(PlayerPedId()),GetHashKey("trpmerj")) then
							RemoveBlip(blips)
