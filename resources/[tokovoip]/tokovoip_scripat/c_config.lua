TokoVoipConfig = {
	...
	radioClickMaxChannel = 1018, -- Set the max amount of radio channels that will have local radio clicks enabled
	radioAnim = true, -- Enable or disable the radio animation
	radioEnabled = true, -- Enable or disable using the radio
	wsServer = "200.9.154.136:9064", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "Conectado",
		TSPassword = "atencaoatencaoveiculoroubado0120", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Aguardando", -- You NEED tokovoip in the wait channel name!

		-- Blocking screen informations
		TSServer = "131.196.199.80:9064", -- TeamSpeak server address to be displayed on blocking screen
