...
function addPlayerToRadio(channelId, playerServerId, radio)
	if (not channels[channelId]) then
		if(radio) then
			...
			channels[channelId] = {id = channelId, name = "Frequencia : " .. channelId, subscribers = {}};
		end
	end
	...
	print("Adicionado [" .. playerServerId .. "] " .. (GetPlayerName(playerServerId) or "") .. " ao canal " .. channelId);
...
function removePlayerFromRadio(channelId, playerServerId)
	if (channels[channelId] and channels[channelId].subscribers[playerServerId]) then
		...
		print("Removido [" .. playerServerId .. "] " .. (GetPlayerName(playerServerId) or "") .. " do canal " .. channelId);
