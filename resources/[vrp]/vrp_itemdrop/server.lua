...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookpegaritem = "https://discordapp.com/api/webhooks/744710843119435796/fbKiXmYkl1hElLf9pCK0oyIXCaJEABCYCS7g2vXTCYjGSMfbGOZw43EE5uj3XMfA04dP"
...
RegisterServerEvent('DropSystem:take6480')
AddEventHandler('DropSystem:take6480',function(id)
	local source = source
	local user_id = vRP.getUserId(source)
	if user_id then
