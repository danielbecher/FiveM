...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustPressed(0,246) and IsPedInAnyVehicle(ped, true) then
            if func.getNitro() then
                ...
                Citizen.Wait(6000)                      ---- aumentar o tempo que nitro ira durar
...
--[[Citizen.CreateThread(function()
    while true do
        ...
        if IsPedInAnyVehicle(ped, true) then
            drawTxt(0.877,0.910,0.42,"NITRO:",200,200,200,255)
            drawTxt(0.903,0.910,0.42,nitro,255,0,0,255)
            if nitro == 0 then
                drawTxt(0.903,0.910,0.42,"0",200,200,200,255)
            end    
        end
    end
end)
