...
Citizen.CreateThread(function()
    ...
    Citizen.Wait(8)	
        ...
        if GetDistanceBetweenCoords(coords, 117.19, -1294.86, 28.42, true) < 100 then
			...
			timpPayday(1.15, 1.46, 1.0,1.0,0.4,"~w~Pressione ~r~[ E ]~w~ para o show de strip", 255, 255, 255, 150)
...
function timpPayday(x,y ,width,height,scale, text, r,g,b,a)
    SetTextFont(4)
    ...
    DrawText(x - width/2, y - height/1 + 0.49)
end
...
AddEventHandler('hp_lapdance:lapdance', function()
			...
			TaskPlayAnim(SpawnObject, "mini@strip_club@private_dance@part3", "priv_dance_p3", 8.0, -8.0, -1, 0, 0, false, false, false)
			Citizen.Wait(25000)
			Citizen.Wait(5000)
